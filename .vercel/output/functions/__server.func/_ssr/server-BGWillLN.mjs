import { r as __exportAll, t as __exportAll$1 } from "./rolldown-runtime-D7D4PA-g.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BGWillLN.js
var server_BGWillLN_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C131cRP6.mjs");
...
var manifest = { "45c162b4731ce8757496d62913bb04bbb6ce40b9bd2fb5c96367897e5fe897be": {
	functionName: "sendEnquiry_createServerFn_handler",
	importer: () => import("./contact.functions-DJoDCnVR.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C6d_usC-.mjs").then((n) => n.m).then((n) => n.t),
...
//#endregion
export { server_BGWillLN_exports as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
